...
echo "🚀 Setting up base Terraform configuration..."
echo ""
...
EOF
  ...
  echo "ℹ️  Skipping main.tf (already exists)"
fi
...
EOF
  ...
  echo "ℹ️  Skipping variables.tf (already exists)"
fi
...
echo ""
echo "✅ Base Terraform configuration created successfully!"
echo ""
echo "📂 Created files:"
