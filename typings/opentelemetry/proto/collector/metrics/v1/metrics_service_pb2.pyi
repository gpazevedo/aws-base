...
class ExportMetricsServiceRequest(google.protobuf.message.Message):
    ...
    def __init__(self, *, resource_metrics: collections.abc.Iterable[opentelemetry.proto.metrics.v1.metrics_pb2.ResourceMetrics] | None = ...) -> None:
        ...
...
class ExportMetricsServiceResponse(google.protobuf.message.Message):
    ...
    def __init__(self, *, partial_success: global___ExportMetricsPartialSuccess | None = ...) -> None:
        ...
...
class ExportMetricsPartialSuccess(google.protobuf.message.Message):
    ...
    def __init__(self, *, rejected_data_points: builtins.int = ..., error_message: builtins.str = ...) -> None:
        ...
