...
from opentelemetry.instrumentation._semconv import HTTP_DURATION_HISTOGRAM_BUCKETS_NEW, _OpenTelemetrySemanticConventionStability, _OpenTelemetryStabilitySignalType, _StabilityMode, _filter_semconv_active_request_count_attr, _filter_semconv_duration_attrs, _get_schema_url, _report_new, _report_old, _server_active_requests_count_attrs_new, _server_active_requests_count_attrs_old, _server_duration_attrs_new, _server_duration_attrs_old, _set_http_flavor_version, _set_http_host_server, _set_http_method, _set_http_net_host_port, _set_http_peer_ip_server, _set_http_peer_port_server, _set_http_scheme, _set_http_target, _set_http_url, _set_http_user_agent, _set_status
...
from opentelemetry.util.http import ExcludeList, OTEL_INSTRUMENTATION_HTTP_CAPTURE_HEADERS_SANITIZE_FIELDS, OTEL_INSTRUMENTATION_HTTP_CAPTURE_HEADERS_SERVER_REQUEST, OTEL_INSTRUMENTATION_HTTP_CAPTURE_HEADERS_SERVER_RESPONSE, SanitizeValue, _parse_url_query, get_custom_headers, normalise_request_header_name, normalise_response_header_name, parse_excluded_urls, redact_url, sanitize_method
...
def get_host_port_url_tuple(scope): # -> tuple[Any, Any, Any]:
...
class OpenTelemetryMiddleware:
    ...
    """
    def __init__(self, app, excluded_urls: ExcludeList | str | None = ..., default_span_details=..., server_request_hook: ServerRequestHook = ..., client_request_hook: ClientRequestHook = ..., client_response_hook: ClientResponseHook = ..., tracer_provider=..., meter_provider=..., tracer=..., meter=..., http_capture_headers_server_request: list[str] | None = ..., http_capture_headers_server_response: list[str] | None = ..., http_capture_headers_sanitize_fields: list[str] | None = ..., exclude_spans: list[typing.Literal["receive", "send"]] | None = ...) -> None:
        ...
    
    async def __call__(self, scope: typing.MutableMapping[str, Any], receive: Callable[[], Awaitable[typing.MutableMapping[str, Any]]], send: Callable[[typing.MutableMapping[str, Any]], Awaitable[None]]) -> None:
