...
class BatchSpanProcessor(SpanProcessor):
    ...
    """
    def __init__(self, span_exporter: SpanExporter, max_queue_size: int | None = ..., schedule_delay_millis: float | None = ..., max_export_batch_size: int | None = ..., export_timeout_millis: float | None = ...) -> None:
        ...
    
    @property
    def span_exporter(self): # -> Exporter[ReadableSpan]:
        ...
    ...
    def force_flush(self, timeout_millis: typing.Optional[int] = ...) -> bool:
        ...
...
class ConsoleSpanExporter(SpanExporter):
    ...
    """
    def __init__(self, service_name: str | None = ..., out: typing.IO = ..., formatter: typing.Callable[[ReadableSpan], str] = ...) -> None:
        ...
