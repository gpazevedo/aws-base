...
class Counter(Synchronous):
    ...
    @abstractmethod
    def add(self, amount: Union[int, float], attributes: Optional[Attributes] = ..., context: Optional[Context] = ...) -> None:
        ...
...
class Histogram(Synchronous):
    ...
    """
    @abstractmethod
    def __init__(self, name: str, unit: str = ..., description: str = ..., explicit_bucket_boundaries_advisory: Optional[Sequence[float]] = ...) -> None:
        ...
    
    @abstractmethod
    def record(self, amount: Union[int, float], attributes: Optional[Attributes] = ..., context: Optional[Context] = ...) -> None:
        ...
...
class Gauge(Synchronous):
    ...
    @abstractmethod
    def set(self, amount: Union[int, float], attributes: Optional[Attributes] = ..., context: Optional[Context] = ...) -> None:
        ...
