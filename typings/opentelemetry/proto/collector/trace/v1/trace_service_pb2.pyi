...
class ExportTraceServiceResponse(google.protobuf.message.Message):
    ...
    def __init__(self, *, partial_success: global___ExportTracePartialSuccess | None = ...) -> None:
        ...
...
class ExportTracePartialSuccess(google.protobuf.message.Message):
    ...
    def __init__(self, *, rejected_spans: builtins.int = ..., error_message: builtins.str = ...) -> None:
        ...
