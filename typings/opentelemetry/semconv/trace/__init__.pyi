...
@deprecated("Use attributes defined in the :py:const:`opentelemetry.semconv.attributes` and :py:const:`opentelemetry.semconv._incubating.attributes` modules instead. Deprecated since version 1.25.0.")
...
@deprecated("Removed from the specification in favor of `network.protocol.name` and `network.protocol.version` attributes. Deprecated since version 1.18.0.")
...
@deprecated("Removed from the specification. Deprecated since version 1.18.0.")
class MessagingDestinationKindValues(Enum):
    QUEUE = ...
    TOPIC = ...


@deprecated("Renamed to NetworkConnectionTypeValues. Deprecated since version 1.21.0.")
...
@deprecated("Renamed to NetworkConnectionSubtypeValues. Deprecated since version 1.21.0.")
...
@deprecated("Use :py:const:`opentelemetry.semconv.attributes.NetworkTransportValues` instead. Deprecated since version 1.25.0.")
...
@deprecated("Use :py:const:`opentelemetry.semconv.attributes.NetworkType` instead. Deprecated since version 1.25.0.")
...
@deprecated("Use :py:const:`opentelemetry.semconv.attributes.HttpRequestMethodValues` instead. Deprecated since version 1.25.0.")
...
@deprecated("Use :py:const:`opentelemetry.semconv._incubating.attributes.LogIostreamValues` instead. Deprecated since version 1.25.0.")
...
@deprecated("Use :py:const:`opentelemetry.semconv._incubating.attributes.OpentracingRefTypeValues` instead. Deprecated since version 1.25.0.")
