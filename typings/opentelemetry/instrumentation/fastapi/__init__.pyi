...
from opentelemetry.instrumentation._semconv import _OpenTelemetrySemanticConventionStability, _OpenTelemetryStabilitySignalType, _StabilityMode, _get_schema_url
...
class FastAPIInstrumentor(BaseInstrumentor):
    ...
    _original_fastapi = ...
    @staticmethod
    def instrument_app(app: fastapi.FastAPI, server_request_hook: ServerRequestHook = ..., client_request_hook: ClientRequestHook = ..., client_response_hook: ClientResponseHook = ..., tracer_provider: TracerProvider | None = ..., meter_provider: MeterProvider | None = ..., excluded_urls: str | None = ..., http_capture_headers_server_request: list[str] | None = ..., http_capture_headers_server_response: list[str] | None = ..., http_capture_headers_sanitize_fields: list[str] | None = ..., exclude_spans: list[Literal["receive", "send"]] | None = ...): # -> None:
...
class _InstrumentedFastAPI(fastapi.FastAPI):
    ...
    _instrumented_fastapi_apps: _WeakSet[fastapi.FastAPI] = ...
