...
class _AggregationTemporalityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AggregationTemporality.ValueType], builtins.type):
    ...
    AGGREGATION_TEMPORALITY_UNSPECIFIED: _AggregationTemporality.ValueType
    AGGREGATION_TEMPORALITY_DELTA: _AggregationTemporality.ValueType
    AGGREGATION_TEMPORALITY_CUMULATIVE: _AggregationTemporality.ValueType
    ...
...
AGGREGATION_TEMPORALITY_DELTA: AggregationTemporality.ValueType
...
class _DataPointFlagsEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DataPointFlags.ValueType], builtins.type):
    ...
    DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK: _DataPointFlags.ValueType
    ...
...
DATA_POINT_FLAGS_DO_NOT_USE: DataPointFlags.ValueType
...
class MetricsData(google.protobuf.message.Message):
    ...
    def __init__(self, *, resource_metrics: collections.abc.Iterable[global___ResourceMetrics] | None = ...) -> None:
        ...
...
class ResourceMetrics(google.protobuf.message.Message):
    ...
    def __init__(self, *, resource: opentelemetry.proto.resource.v1.resource_pb2.Resource | None = ..., scope_metrics: collections.abc.Iterable[global___ScopeMetrics] | None = ..., schema_url: builtins.str = ...) -> None:
        ...
...
class ScopeMetrics(google.protobuf.message.Message):
    ...
    schema_url: builtins.str
    def __init__(self, *, scope: opentelemetry.proto.common.v1.common_pb2.InstrumentationScope | None = ..., metrics: collections.abc.Iterable[global___Metric] | None = ..., schema_url: builtins.str = ...) -> None:
        ...
...
class Metric(google.protobuf.message.Message):
    ...
    def __init__(self, *, name: builtins.str = ..., description: builtins.str = ..., unit: builtins.str = ..., gauge: global___Gauge | None = ..., sum: global___Sum | None = ..., histogram: global___Histogram | None = ..., exponential_histogram: global___ExponentialHistogram | None = ..., summary: global___Summary | None = ..., metadata: collections.abc.Iterable[opentelemetry.proto.common.v1.common_pb2.KeyValue] | None = ...) -> None:
        ...
...
class Gauge(google.protobuf.message.Message):
    ...
    def __init__(self, *, data_points: collections.abc.Iterable[global___NumberDataPoint] | None = ...) -> None:
        ...
...
class Sum(google.protobuf.message.Message):
    ...
    def __init__(self, *, data_points: collections.abc.Iterable[global___NumberDataPoint] | None = ..., aggregation_temporality: global___AggregationTemporality.ValueType = ..., is_monotonic: builtins.bool = ...) -> None:
        ...
...
class Histogram(google.protobuf.message.Message):
    ...
    aggregation_temporality: global___AggregationTemporality.ValueType
    def __init__(self, *, data_points: collections.abc.Iterable[global___HistogramDataPoint] | None = ..., aggregation_temporality: global___AggregationTemporality.ValueType = ...) -> None:
        ...
...
class ExponentialHistogram(google.protobuf.message.Message):
    ...
    aggregation_temporality: global___AggregationTemporality.ValueType
    def __init__(self, *, data_points: collections.abc.Iterable[global___ExponentialHistogramDataPoint] | None = ..., aggregation_temporality: global___AggregationTemporality.ValueType = ...) -> None:
        ...
...
class Summary(google.protobuf.message.Message):
    ...
    def __init__(self, *, data_points: collections.abc.Iterable[global___SummaryDataPoint] | None = ...) -> None:
        ...
...
class NumberDataPoint(google.protobuf.message.Message):
    ...
    flags: builtins.int
    def __init__(self, *, attributes: collections.abc.Iterable[opentelemetry.proto.common.v1.common_pb2.KeyValue] | None = ..., start_time_unix_nano: builtins.int = ..., time_unix_nano: builtins.int = ..., as_double: builtins.float = ..., as_int: builtins.int = ..., exemplars: collections.abc.Iterable[global___Exemplar] | None = ..., flags: builtins.int = ...) -> None:
        ...
...
class ExponentialHistogramDataPoint(google.protobuf.message.Message):
    ...
    class Buckets(google.protobuf.message.Message):
        ...
        def __init__(self, *, offset: builtins.int = ..., bucket_counts: collections.abc.Iterable[builtins.int] | None = ...) -> None:
            ...
...
class Exemplar(google.protobuf.message.Message):
    ...
    def __init__(self, *, filtered_attributes: collections.abc.Iterable[opentelemetry.proto.common.v1.common_pb2.KeyValue] | None = ..., time_unix_nano: builtins.int = ..., as_double: builtins.float = ..., as_int: builtins.int = ..., span_id: builtins.bytes = ..., trace_id: builtins.bytes = ...) -> None:
        ...
