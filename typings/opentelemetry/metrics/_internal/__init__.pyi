...
from opentelemetry.metrics._internal.instrument import CallbackT, Counter, Gauge, Histogram, NoOpCounter, NoOpGauge, NoOpHistogram, NoOpObservableCounter, NoOpObservableGauge, NoOpObservableUpDownCounter, NoOpUpDownCounter, ObservableCounter, ObservableGauge, ObservableUpDownCounter, UpDownCounter, _MetricsHistogramAdvisory, _ProxyCounter, _ProxyGauge, _ProxyHistogram, _ProxyObservableCounter, _ProxyObservableGauge, _ProxyObservableUpDownCounter, _ProxyUpDownCounter
...
class Meter(ABC):
    ...
    @abstractmethod
    def create_histogram(self, name: str, unit: str = ..., description: str = ..., *, explicit_bucket_boundaries_advisory: Optional[Sequence[float]] = ...) -> Histogram:
...
def get_meter(name: str, version: str = ..., meter_provider: Optional[MeterProvider] = ..., schema_url: Optional[str] = ..., attributes: Optional[Attributes] = ...) -> Meter:
    """Returns a `Meter` for use by the given instrumentation library.
